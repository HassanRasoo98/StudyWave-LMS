...
const MyCourses = () => {
  ...
  const getCourses = async () => {
    try {
      ...
      // Deduplicate courses based on their unique `id`
      const uniqueCourses = res.data.enrolledCourses.filter((course, index, self) =>
        index === self.findIndex((c) => c.coursecode === course.coursecode)
      );
  
      // Set the unique courses to the state
          ...
          <div className="userrowcontainer">
            <div className="usercolcontainer">
              <div className="usertopsearch">
                ...
                <span className="dispcoursecount">{courses.length}</span>
            ...
            <div className="usercourse-item-body">
              ...
              <div className="usercourse-item-footer">
                ...
                <ul>
                  <li>
                    <NavLink
                      to={`/user-dashboard/viewcourse/${course._id}`}
